...
* Produces a file "SICE_00MH.csv" in the base directory
file results /SICE_00MH.csv/; results.nd = 10 ; results.nw = 0 ; results.pw=20000; results.pc=5;
put results;
put /"Results of DICE-2016R model run using model SICE_00MH.csv";
